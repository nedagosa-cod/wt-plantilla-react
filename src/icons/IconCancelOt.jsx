const IconCancelOt = () => {
	return (
		<svg
			...
			version="1.1"
			id="svg9724"
			sodipodiDocname="cancel-circle.svg"
			inkscapeVersion="1.2.2 (1:1.2.2+202212051550+b0a8486541)"
			...
			<g id="SVGRepo_iconCarrier">
				...
				<g
					...
					<g
						...
						style="strokeWidth:50.6951"></g>{' '}
					<path
						style="color:#000000;fill:#000000;strokeLinecap:round;strokeLinejoin:round;-inkscape-stroke:none;paint-order:stroke fill markers"
						...
						id="path390"></path>{' '}
					<path
						style="color:#000000;fill:#000000;strokeLinecap:round;strokeLinejoin:round;-inkscape-stroke:none"
