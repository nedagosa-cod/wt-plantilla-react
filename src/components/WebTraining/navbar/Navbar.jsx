		...
		<div className="w-full relative">
          ...
          `}
							...
							<button
								...
								className="group bg-gradient-to-r from-[hsl(var(--primarywt))] to-[hsl(var(--primarywt))] rounded absolute left-1/2 transform -translate-x-1/2 hover:bg-[hsl(var(--primary-light))] py-1 px-3 shadow-xl shadow-primary transition-all z-20 aspect-square cursor-pointer [box-shadow:#3c40434d_0_1px_2px_0,#3c404326_0_2px_6px_2px,#0000004d_0_30px_60px_-30px,#34343459_0_-2px_6px_0_inset] flex items-center justify-center flex-col"
								aria-label="Buscar">
					...
					<div className="flex items-center justify-end space-x-4 w-1/4 h-full bg-gradient-to-r from-white via-white to-[hsl(var(--primary-dark))]">
						<div className="w-1 h-12 rounded bg-gradient-to-b from-primary to-[hsl(var(--primary-dark))]"></div>
						<div className="flex items-center bg-white h-full rounded-r-full">
